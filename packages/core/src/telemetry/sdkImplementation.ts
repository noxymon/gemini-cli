...
import type { LogRecordExporter , BatchLogRecordProcessor } from '@opentelemetry/sdk-logs';
...
import { flushTelemetryBuffer } from './telemetryBuffer.js';
...
export async function initializeTelemetry(
  ...
  if (useDirectGcpExport) {
    ...
    const { GcpTraceExporter, GcpMetricExporter, GcpLogExporter } =
