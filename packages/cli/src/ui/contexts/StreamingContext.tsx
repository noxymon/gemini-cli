...
import type { StreamingState, HistoryItemWithoutId, ThoughtSummary, ActiveHook } from '../types.js';
...
export const StreamingContext = createContext<StreamingContextValue | undefined>(
  undefined,
);
